...
lolquotes = [
  ...
  "A ver cuánto es 3+2?",
  "Jesse, tú no eres Jesse y Joy",
  "Alto mi pana, INPECCIÓN DE PENES",
  "TOP personajes con poses god, #1: tu mamá en 4",
  "Quieres volverte princesa? Déjame besarte el sapo",
  "Fui a alcohólicos anónimos y ninguno anónimo, puro compa",
  "QUÉ ABOGADO",
  "hoy me siento romántico xddxd",
  "awa de uwu con un poco de owo",
  "Marcelo, agacháte y conocelo (un beatbox bien demencial acá :v)",
  "PORONGA xddxd",
  "Un hombre soltero después de los 30 ser como (Padrastro, Soltero para Siempre, GORDAS)",
  "WHEN HACES TUS MOMOS EN VIDEOS",
  "'Torturan a esposa haciéndola ver One Piece' -- CULTURA OTAKU",
  "12 + 1 ????????, mueve respondiendo gil",
  "Al fin, some fucking frio",
  "Descansa, duerme ya, O MI PUÑO PROBARAS",
  "Pasen contenido audiovisual de la reproducción humana",
  "Pasa pasa ig de la minita",
  "Estoy triste, pase su tarjeta de crédito",
  "Mujer en el equipo GG",
  "TUMBA LA CASA MAMI",
  "Cuidado que pusieron MAMARRRE",
  "ERI GEY??",
  "HOY VOY A CONVERTIRME EN TORAX",
  "Si WhatsApp es tan bueno, por qué no hay WhatsApp 2",
  "CMEN",
  "CUM",
  "MI VIEJA DON PENDEJO",
  "CAGASTE",
  "Pensé en algo más gracioso que 24",
  "Tu papá usa GarchaLife xdddxd",
  "Quieres un chiste opresor... Porno",
  "Feliz CUM",
  "La palabra amigos al revés es sogima que significa amigos pero al revés",
  "TU VIEJA COME PLASTILINA",
  "BOMBARDEEEN PERÚ",
  "Un león siempre cuida de su leono",
  "Eso diría un maricón",
  "Pruébame ESTA",
  "Tu mamá es travesti",
  "Que quieres que haga, te aplaudo o k",
  "pongan a dady yanki",
  "No llores joto",
  "uele a perra",
  "Huele a obo :v",
  "Te mandó saludos Estefi v:",
  "SOPA DU MACACO, UMA DELIZIA",
  "PASEN TETAS",
  "PINCHES N",
  "Despídete bien",
  "Raza, alguien sabe como dormir 8 hrs en 4hrs :'v, (Duerme en dos camas :v)",
  "Por eso no le dan internet a los indigenas xddxd",
  "8x8 AGARRAME EL CHOCHO JAJASJJAJASSJA CHISTOSO",
  "NO GRACIAS YO SI TENGO PAPÁ",
  "LEVANTO FIERROS, POR QUE CULOS NINGUNO",
  "TU MAMÁ ES MI CARDIO",
  "Nadie: Niñas al cumplir 13,14 o 15 años (BUSCANDO WEBO xdddxd)",
  "Los prietos no lloran ... ",
  "La cara de la cariñosa cuando le empiezo a explicarle las 4 libertades esenciales del software libre",
  "SEXISMO: Miedo a tener sexo",
  "Cierra el putísimo culo xddxd",
  "PINCHES PUTOS PENDEJOS, PENDEJOS PUTOS IDIOTAS PENDEJOS",
  "Ilustración digital hilarante con toques sarcásticos, irónicos y satíricos, que reflejan claramente un contexto el cual no se debe tomar en serio, ya que es solo una representación gráfica de un chiste",
  "El increíble mundo del SIDA xddxd",
  "* c sonrroja y gime *",
  "Encontraron el CP!!!! :vvvVv",
  "N___A: NINJA NINJA",
  "MMMM A VER TU MOMO",
  "AH, NO LE SABES, NO LE SABES AL CHITPOS",
  "HAGANLE UN CHEEMS, UN MOMICHI, UN GLOBO DE TEXTO, UN CURICERDO, UN SOUL, UN WOJAK, UN PACMAN, UN MIGUEL, UN EDIT DE JOJOS, DIGANLE GROSERIAS, INSULTOS, QUE NO LE SABE, PONGALE UN TRAJE DE MONA CHINA, FUNENLO, DIGANLE SIMP Y SAQUENLO",
  "hora de ver momos A ver el tuyo",
  "FUERA ESPÍRITU HOMOSEXUAL",
  "QUÉ... que me destierras, ah está bien, no estoy de acuerdo con tus políticas",
  "Cuando te sientas triste, córtate el pito, ahora sentirás dolor y ya no te sentirás triste",
  "PREPARATE LA P*TA QUE TE REPARIÓ, POR QUE, LOS VIERNES DE LA JUNGLA SERÁN A TODO OJETE",
  "PARA VIVIR UNA NOCHE, CON LAS MEJORES P*TAS DE LA ZONA, NO TE LA PUEDES PERDER HIJO DE REMIL, POR QUE SI NO ESTÁS AHÍ, ANDATE A LA CONCHA DE LA LORA",
  "Yo no konfio ni enmi sombra pq es negra",
  "LAS TETAS SOLO SON NALGAS CON PEZONES",
  "QUE TE PASE EL DIA",
  "la paja es sexo light",
  "soy una persona EXITOSA por que cada vez que te veo ME EXCITO",
  "Dejaron la CocaCola mal tapada y se le fue el gas ... :c",
  "Y así, Dios dijo Que.....so JASJAJSAJ QUE CHISTOSO PERO RIETE PUTO",
  "Pake tener autoestima si puedo tener un auto encima",
  "Soy como un reloj, me adapto a cualquier muñeca",
  "Casi conecto el internet",
